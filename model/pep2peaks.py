...
def parse_args():
    ...
    parser.add_argument('--ion_type', type=str, default='internal', help="regular or internal") 
    parser.add_argument('--model', type=str, default='models/internal_proteometools_NCE25_no_inten_threshold/', help="") 
    parser.add_argument('--input_dim', type=int, default=198,help='173 if regular else 198')
    parser.add_argument('--output_dim', type=int, default=2,help='2 if regular else 2')
...
def train(args):
    ...
    with tf.Session() as sess:
        ...
        #train data
        _,_,train_X,train_y,merge_train_list,_=datam.get_data('data/data_proteometools/no_inten_threshold/NCE25_ay_by_train.txt',args.min_internal_ion_len,args.max_internal_ion_len,'')
        ...
        #val data
        _,_,val_X,val_y,merge_val_list,_=datam.get_data('data/data_proteometools/no_inten_threshold/NCE25_ay_by_test.txt',args.min_internal_ion_len,args.max_internal_ion_len,'')
        ...
        for Iter in range(args.num_iter):
            ...
            if best_loss > val_loss/val_batch_number:
                ...
                print("Saved best Model:",model.saver.save(sess, 'models/internal_proteometools_NCE25_no_inten_threshold/model.ckpt'))
...
def model_predict(args):
    ...
    idx,peptide,test_X,test_y,merge_test_list,ions=datam.get_data('data/data_proteometools/no_inten_threshold/NCE25_ay_by_test.txt',args.min_internal_ion_len,args.max_internal_ion_len,args.is_mobile)
