...
def train(args,internal_ion_len):
    ...
    with tf.Session() as sess:
        ...
        #train data
        _,_,train_X,train_y,merge_train_list,_=datam.get_data('data/data_mm/ay_by_train.txt',internal_ion_len)
        ...
        for Iter in range(args.num_iter):
            ...
            if best_loss > val_loss/val_batch_number:
                ...
                print("Saved best Model:",model.saver.save(sess, 'models/models/model.ckpt'))
...
def model_predict(args):
    ...
    with tf.Session() as session:
        model.saver.restore(session, tf.train.get_checkpoint_state('models/models/').model_checkpoint_path)
...
def main(args):
    ...
    if(args.is_train==1):
        train(args,args.max_internal_ion_len)
